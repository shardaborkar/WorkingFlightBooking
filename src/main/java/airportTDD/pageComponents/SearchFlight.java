...
public SearchFlight(WebDriver driver,By multiCity,By oneWay,By roundTrip) {
this.driver=driver;	
...
public void selectOption(String journeyType) throws InterruptedException {
...
public void departureDate(String journeyType) throws InterruptedException {
...
/*public HolidayPackage clickOnHolidayPackage() throws InterruptedException {
	Thread.sleep(3000);
	holidayPack.click();
	Thread.sleep(5000);
	return new HolidayPackage(driver);
}*/
